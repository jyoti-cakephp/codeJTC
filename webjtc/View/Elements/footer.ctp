...
<?php $popup = $this->requestAction(array('controller' => 'users', 'action' => 'popup')); //pr($popup);die; ?>
<script>
    var SITEPATH = '<?php echo SITEPATH; ?>';
    //alert(SITEPATH);
</script>
<?php if($popup['User']['pop_up']=="1") { ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-offset-xs-6">
                <ul class="footer-list category">
                    ...
                    <li><?php echo $this->html->image('footer-mail.png', array('class' => 'footer-arrow')); ?><a href="mailto:info@jtcbabywear.co.uk">info@jtcbabywear.co.uk</a></li>
                    <li><?php echo $this->html->image('fph.png', array('class' => 'footer-arrow')); ?><a href="tel:+44 (0)121 333 7374">+44 (0)121 333 7374</a></li>
                    <li style="color: #fff;">Opening Hours:Mon-Fri 10am-6pm</li>
        ...
        <div class="row">
            <div class="col-md-12 copy text-center">
                <p class="copyright">© 2017 jtcbabywear.co.uk all rights reserved, web design & developed by<a href="http://www.sdssoftwares.co.uk"><font color="white">SDSSoftwares.co.uk</font></a></p>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="col-sm-offset-3 col-sm-9">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <p class="forget-pass"><a type="submit" data-toggle="modal" data-target="#myModal3">Forgot password?</a></p>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo $this->Form->create('User', array('class' => 'form-horizontal', 'id' => 'UserRegisterForm','onsubmit'=>"return validateform1()")); ?>          
    ...
    $(document).ready(function() {
        var validator = $("#myformId1").validate({
            ...
            messages: {
                ...
                "data[Contact][message]": {
                    required: "Enquiry should not be blank.<br/>"
                }
            }
        });
    });

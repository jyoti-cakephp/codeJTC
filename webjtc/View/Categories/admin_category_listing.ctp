    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title" style="border-bottom:none;">
                <div class="caption">
                    <i class="fa fa-reorder"></i>Category Listing
                    ...
                    <tbody>
                        ...
                        foreach ($userList as $result) { ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo $this->html->url(array('controller' => 'categories', 'action' => 'admin_edit', $result['Category']['id'])) ?>"><?php echo $this->html->image('user_edit.png', array('title' => 'Edit')); ?></a></td>
                                <td> <?php

                            ...
                            <form class="form-inline">
                                ...
                                <div class="form-body">
								  ...
								  <?php $name = $this->Session->read('name'); ?> 
                                                ...
                                                <input type="text" class="form-control" id="ptitle" name="name" value="<?php if(!empty($name)){ echo $name;} ?>">
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <?php if(!empty($name) && !empty($this->params['named']['page'])) { ?>
                                        <div class="col-md-12 text-center">
                                                <button type="button" class="btn green" onclick="search()">SEARCH</button>
                                        </div>
                                        <?php }else if(empty($name) && !empty($this->params['named']['page'])){ ?>
                                        <div class="col-md-12 text-center">
                                                <button type="button" class="btn green" onclick="search()">SEARCH</button>
                                        </div>
...
<Script>
    ...
    function search(){
       ...
       window.location.href = SITEPATH + "admin/products/productListing" + '?name='+value;
    }
</script>

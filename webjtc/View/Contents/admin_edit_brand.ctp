    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green ">
            <div class="portlet-title">
                <div class="caption">Edit Brand</div>
            </div>
                ...
                <div class="form-body">
                    <div class="form-body">             
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <?php echo $this->Form->text('brand_name', array("class" => "form-control", 'name' => 'data[Brand][brand_name]' ,'value'=>$brandList['Brand']['brand_name'])); ?>
                            </div>
                        </div>
                    </div>

...
<div class="prod-number"><p class="idnum"><strong><?php echo $product['Product']['product_code']?></strong></p></div>
 ...
 <a href="<?php echo $this->html->url(array('controller'=>'products','action'=>'productList',$result['ProductSize'][0]['product_size']))?>"><?php echo $this->html->image('redirect3.png',array('class'=>''))?></a>   
</figure>
    <?php } ?>
...
<?php  } }?> 
 ...
 <?php } else { ?>
    <div class="message1">No Products Available.</div>
  <?php } ?>

...
<div class="row">
    <div class="col-md-12">
            ...
            <div class="portlet-body form">
                ...
                <?php echo $this->Form->create('Image', array('controller' => 'images', 'action' => 'addProduct','id' => 'formid', 'class' => 'form-horizontal', 'type' => 'file')); ?>
                <div class="form-body">
                    <div class="form-body">
                      ...
                      <!--    <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <?php //echo $this->Form->textarea('short_description', array( 'class' => 'ckeditor','name' => 'data[Product][short_description]')); ?>
                            </div>
                        </div>-->

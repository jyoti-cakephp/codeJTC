                ...
                <div class="form-body">
                    <div class="form-body">             
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <?php echo $this->Form->text('product_size', array("class" => "form-control", 'name' => 'data[Size][product_size]')); ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-6">
                            ...
                            <a class="btn default" href="<?php echo $this->Html->url(array('controller' => 'homes', 'action' => 'admin_sizeListing')); ?>">Cancel</a>
                        </div>
                    </div>
                </div>

                   ...
                   <td colspan="9" class="rounded-foot-left"><em><?php echo $this->element('admin_paging_links'); ?></em></td>
                           ...
                           <?php $i=1; foreach($sizeList as $result) { ?>
                                ...
                                <tr>
                                     ...
                                     <td><a href="<?php echo $this->html->url(array('controller' => 'sizes', 'action' => 'admin_editSize', $result['Size']['id'])) ?>"><?php echo $this->html->image('user_edit.png', array('title' => 'Edit')); ?></a></td>
...
<Script>
       function selectsort() {
        ...
        //alert(value);
        if (value == "ASC") {
            window.location.href = SITEPATH + "admin/sizes/sizeListing" + "/ASC";
        } else if (value == "DESC") {
            window.location.href = SITEPATH + "admin/sizes/sizeListing" + "/DESC";
        }

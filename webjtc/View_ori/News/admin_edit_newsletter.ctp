    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green ">
            <div class="portlet-title">
                <div class="caption">Edit Newsletter
                </div>
            </div>
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <?php echo $this->Form->text('title', array("class" => "form-control",'name'=>'data[Newsletter][email_title]','value'=>$message['Newsletter']['email_title'])); ?>
                        </div>
                    </div>
<div class="form-group">
                        <label class="col-md-3 control-label">Message:</label>
                        <div class="col-md-9">
                      <?php echo $this->Form->textarea('message', array('class' => 'ckeditor','id' => 'noticeMessage','name'=>'data[Newsletter][message]','value'=>$message['Newsletter']['message'])); ?>
                        </div>
                    </div>
                   </div>
